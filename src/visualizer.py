  ...
  function renderHistoricalSummary(data) {{
    ...
    historicalSummaryBox.innerHTML = `
      ...
      <div class="historical-grid">
        <div class="historical-stat"><p class="historical-label">Latest</p><p class="historical-value">${{fmt(last)}}</p></div>
        <div class="historical-stat"><p class="historical-label">Mean</p><p class="historical-value">${{fmt(mean)}}</p></div>
        <div class="historical-stat"><p class="historical-label">Min</p><p class="historical-value">${{fmt(min)}}</p></div>
        <div class="historical-stat"><p class="historical-label">Max</p><p class="historical-value">${{fmt(max)}}</p></div>
      </div>
